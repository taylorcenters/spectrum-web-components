...
export class MenuGroup extends SpectrumElement {
    ...
    private get menuSelects(): void | String {
        console.log(`menuGroup selects: ${this.selects}`)
        switch (this.selects) {
           case undefined: console.log('returning inherit'); return 'inherit';
           case 'none': return undefined;
           default: return this.selects;
        }
    }
    ...
    public render(): TemplateResult {
        ...
        return html`
            ...
            <sp-menu
                selects=${ifDefined(this.menuSelects ? this.menuSelects : undefined)}
                role=${this.menuRole}
            >
                <slot></slot>
            </sp-menu>
